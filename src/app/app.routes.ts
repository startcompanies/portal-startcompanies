...
export const routes: Routes = [
  // ===== REDIRECCIÓN GLOBAL PARA RUTA SIN IDIOMA =====
  {
    path: 'registro-cliente',
    redirectTo: '/es/registro-cliente',
    pathMatch: 'full',
  },
  {
    path: 'client-register',
    redirectTo: '/en/client-register',
    pathMatch: 'full',
  },
      ...
      // ===== RUTAS ESPAÑOLAS =====
      {
        ...
        children: [
          ...
          /**Ruta de registro de cliente */
          {
            ...
            loadComponent: () =>
              import(
                './sections/register-client/register-client.component'
              ).then((m) => m.RegisterClientComponent),
            data: {
              seo: {
                title: 'Registro de Cliente - Start Companies LLC',
                description:
                  'Completa el proceso de registro de cliente en Start Companies paso a paso.',
                keywords: 'registro cliente, crear cuenta, Start Companies LLC',
                ogTitle: 'Registro de Cliente - Start Companies LLC',
                ogDescription:
                  'Completa tu registro de cliente con nuestro asistente paso a paso.',
                ogImage: 'https://startcompanies.us/assets/logo.png',
                twitterSite: '@startcompaniess',
                canonical: 'https://startcompanies.us/registro-cliente',
              },
            },
          },
          /**Landings */
          ...
          },
          {
            ...
            loadComponent: () =>
              import(
                './landings/landing-agendar/landing-agendar.component'
              ).then((m) => m.LandingAgendarComponent),
            data: {
              seo: {
                title: '',
                description: '',
          ...
          /** Forms */
          {
            ...
            data: {
              seo: {
                title:
                  'Apertura de LLC en Estados Unidos - Start Companies LLC',
                description:
                  'Abrimos tu LLC en Estados Unidos de forma rápida y segura. Servicio completo con acompañamiento paso a paso.',
                keywords:
                  'apertura LLC Estados Unidos, crear LLC USA, constitución empresa USA, Start Companies',
          ...
          },
          {
            ...
            data: {
              seo: {
                title:
                  'Apertura de Cuenta Bancaria Relay - Start Companies LLC',
                description:
          ...
          },
          {
            ...
            data: {
              seo: {
                canonical: 'https://startcompanies.us/es/aviso-de-privacidad',
                title: 'Aviso de Privacidad - Start Companies LLC',
                description:
                  'Conoce cómo Start Companies LLC recopila y usa tus datos.',
              },
            },
          },
          {
            ...
            loadComponent: () =>
              import(
                './legal/terms-and-conditions/terms-and-conditions.component'
              ).then((m) => m.TermsAndConditionsComponent),
            data: {
              seo: {
                canonical:
                  'https://startcompanies.us/es/terminos-y-condiciones',
                title: 'Términos y Condiciones - Start Companies LLC',
                description:
                  'Términos y condiciones del sitio de Start Companies LLC.',
              },
            },
          },
          {
          ...
          },
          {
            ...
            data: {
              seo: {
                ...
                ogTitle:
                  'Error 404 - Página No Encontrada | Start Companies LLC',
                ogDescription:
                  'La página que buscas no existe. Regresa al inicio y descubre nuestros servicios para LLC en Estados Unidos.',
                ogImage: 'https://startcompanies.us/assets/logo.png',
                twitterSite: '@startcompaniess',
        ...
        children: [
          // ===== RUTAS EXISTENTES CON SEO COMPLETO EN INGLÉS =====
          {
            ...
            data: {
              seo: {
                ...
                description:
                  'We open bank accounts for LLCs in the United States. 100% online service, no fees and with guarantee. Step-by-step support.',
                keywords:
                  'LLC United States, US bank account, bank account opening, Relay, Start Companies, financial services',
                ogTitle: 'Start Companies LLC - US Bank Account Services',
                ogDescription:
                  'We open bank accounts for LLCs in the United States. 100% online service with no fees.',
                ogImage: 'https://startcompanies.us/assets/logo.png',
                twitterSite: '@startcompaniess',
          ...
          },
          {
            ...
            data: {
              seo: {
                title:
                  'About Us - Start Companies LLC | Financial Services Experience',
                description:
                  'Meet our team and experience in financial services for LLCs in the United States. More than 200 entrepreneurs trust us.',
                keywords:
                  'Start Companies team, financial services experience, about us, entrepreneur trust',
                ogTitle: 'About Us - Start Companies LLC',
                ogDescription:
                  'Meet our team and experience in financial services for LLCs in the United States.',
                ogImage: 'https://startcompanies.us/assets/logo.png',
                twitterSite: '@startcompaniess',
          ...
          },
          {
            ...
            data: {
              seo: {
                ...
                description:
                  'Contact our experts in financial services for LLCs in the United States. Personalized support and quick response.',
                keywords:
                  'Start Companies contact, LLC support, financial services experts, bank account help',
                ogTitle: 'Contact - Start Companies LLC',
                ogDescription:
                  'Contact our experts in financial services for LLCs in the United States.',
                ogImage: 'https://startcompanies.us/assets/logo.png',
                twitterSite: '@startcompaniess',
          ...
          /** Ruta de registro de clientes en ingles */
          {
            path: 'client-register',
            loadComponent: () =>
              import(
            ...
            data: {
              seo: {
                title: 'Client Registration - Start Companies LLC',
                description:
                  'Complete your client account registration step by step.',
                keywords:
                  'client registration, create account, Start Companies',
                ogTitle: 'Client Registration - Start Companies LLC',
                ogDescription:
                  'Create your client account at Start Companies with our step-by-step wizard.',
                ogImage: 'https://startcompanies.us/assets/logo.png',
                twitterSite: '@startcompaniess',
                canonical: 'https://startcompanies.us/en/client-register',
              },
            },
          },
          {
            ...
            data: {
              seo: {
                title:
                  'Plans and Pricing - Start Companies LLC | US LLC Services',
                description:
                  'Discover our plans for LLC formation and bank accounts in the United States. Transparent pricing and complete services.',
                keywords:
                  'US LLC plans, bank account pricing, Start Companies services, LLC formation USA',
                ogTitle: 'Plans and Pricing - Start Companies LLC',
                ogDescription:
                  'Discover our plans for LLC formation and bank accounts in the United States.',
                ogImage: 'https://startcompanies.us/assets/logo.png',
                twitterSite: '@startcompaniess',
          ...
          },
          {
            ...
            data: {
              seo: {
                canonical: 'https://startcompanies.us/en/privacy-policy',
                title: 'Privacy Policy - Start Companies LLC',
                description:
                  'Learn how Start Companies LLC collects and uses your data.',
              },
            },
          },
          {
            ...
            data: {
              seo: {
                canonical: 'https://startcompanies.us/en/terms-and-conditions',
                title: 'Terms and Conditions - Start Companies LLC',
                description:
                  'Terms and conditions of Start Companies LLC website.',
              },
            },
          },
          {
          ...
          /**Landings en inglés */
          {
            ...
            data: {
              seo: {
                title:
                  'Open your LLC in the United States - Start Companies LLC',
                description:
                  'We open your LLC in the United States quickly and safely. Complete service with step-by-step support.',
                keywords:
                  'LLC formation United States, create LLC USA, business formation USA, Start Companies',
                ogTitle:
                  'Open your LLC in the United States - Start Companies LLC',
                ogDescription:
                  'We open your LLC in the United States quickly and safely.',
                ogImage: 'https://startcompanies.us/assets/logo.png',
                twitterSite: '@startcompaniess',
            ...
            data: {
              seo: {
                title:
                  'Open your LLC in the United States - Start Companies LLC',
                description:
                  'We open your LLC in the United States safely and quickly. Complete service with step-by-step support.',
                keywords:
                  'LLC formation United States, create LLC USA, business formation USA, Start Companies',
                ogTitle:
                  'Open your LLC in the United States - Start Companies LLC',
          ...
          },
          {
            ...
            data: {
              seo: {
                ...
                description:
                  'We open your Relay bank account for LLCs in the United States. Simple process and 100% online.',
                keywords:
                  'Relay bank account, Relay account opening, Relay bank USA, Start Companies',
                ogTitle: 'Relay Bank Opening - Start Companies LLC',
                ogDescription:
                  'We open your Relay bank account for LLCs in the United States.',
                ogImage: 'https://startcompanies.us/assets/logo.png',
                twitterSite: '@startcompaniess',
          ...
          },
          {
            ...
            data: {
              seo: {
                ...
                keywords:
                  'schedule consultation, Start Companies, expert advice',
                ogTitle: 'Schedule',
            ...
            data: {
              seo: {
                ...
                description:
                  'We open your LLC in the United States quickly and safely. Complete service with step-by-step support.',
                keywords:
                  'LLC opening United States, create LLC USA, business formation USA, Start Companies',
                ogTitle:
                  'LLC Opening in the United States - Start Companies LLC',
                ogDescription:
                  'We open your LLC in the United States quickly and safely.',
                ogImage: 'https://startcompanies.us/assets/logo.png',
                twitterSite: '@startcompaniess',
          ...
          },
          {
            ...
            data: {
              seo: {
                ...
                description:
                  'We renew your LLC in the United States before it expires. Avoid penalties and keep your business active.',
                keywords:
                  'LLC renewal United States, renew LLC USA, keep LLC active, Start Companies',
                ogTitle:
                  'LLC Renewal in the United States - Start Companies LLC',
                ogDescription:
                  'We renew your LLC in the United States before it expires.',
                ogImage: 'https://startcompanies.us/assets/logo.png',
                twitterSite: '@startcompaniess',
          ...
          },
          {
            ...
            data: {
              seo: {
                ...
                description:
                  'We open your Relay bank account for LLCs in the United States. Simple form and 100% online process.',
                keywords:
                  'Relay bank account, Relay account opening, Relay bank USA, Start Companies',
          ...
          },
          {
            ...
            data: {
              seo: {
                title:
                  'Relay Fixcal Bank Account Opening - Start Companies LLC',
                description:
                  'We open your Relay Fixcal bank account for LLCs in the United States. Simple form and 100% online process.',
                keywords:
                  'Relay Fixcal bank account, Fixcal account opening, Fixcal bank USA, Start Companies',
                ogTitle:
                  'Relay Fixcal Bank Account Opening - Start Companies LLC',
                ogDescription:
                  'We open your Relay Fixcal bank account for LLCs in the United States.',
                ogImage: 'https://startcompanies.us/assets/logo.png',
                twitterSite: '@startcompaniess',
          ...
          },
          {
            ...
            data: {
              seo: {
                title:
                  'Relay Abotax Bank Account Opening - Start Companies LLC',
                description:
                  'We open your Relay Abotax bank account for LLCs in the United States. Simple form and 100% online process.',
                keywords:
                  'Relay Abotax bank account, Abotax account opening, Abotax bank USA, Start Companies',
                ogTitle:
                  'Relay Abotax Bank Account Opening - Start Companies LLC',
                ogDescription:
                  'We open your Relay Abotax bank account for LLCs in the United States.',
                ogImage: 'https://startcompanies.us/assets/logo.png',
                twitterSite: '@startcompaniess',
          ...
          },
          {
            ...
            data: {
              seo: {
                ...
                description:
                  'The page you are looking for does not exist. Return to the homepage and discover our services for LLCs in the United States.',
                keywords:
                  'error 404, page not found, Start Companies, LLC services',
