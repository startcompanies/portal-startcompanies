  ...
  private sanitizeHtml() {
    ...
    content = content.replace(
      ...
      (match, beforeHref, href, afterHref, linkContent) => {
        ...
        const hasStyles =
          match.includes('abrir-llc-btn') ||
          match.includes('background-color: var(--color-secundario-tecnico)');
        ...
        const isInBackgroundSection =
          /section[^>]*style\s*=\s*["'][^"']*background-image[^"']*["']/i.test(
            contextBefore,
          );
