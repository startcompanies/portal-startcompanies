...
export class RegisterService {
    ...
    register(data: RegisterData): Observable<RegisterUserResponse> {
        console.log(`${environment.apiUrl}`);
        return this.http.post<RegisterUserResponse>(`${this.apiUrl}/wizard/requests/register`, data);
    }

    /**
     * Verifica el email del usuario usando el token recibido por correo
     */
    verifyEmail(data: VerifyEmail): Observable<VerifyEmailResponse> {
        return this.http.post<VerifyEmailResponse>(`${this.apiUrl}/wizard/requests/confirm-email`, data).pipe(
            tap(response => {
