...
export class LandingPresentacionComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.facebookPixelService.trackViewContent('Presentación LLC', 'LLC Services');
  }
