...
export class LandingLlc7DiasComponent implements AfterViewInit, OnInit {
  ...
  ngOnInit(): void {
    ...
    this.facebookPixelService.trackViewContent(
      'Landing Presentación 4 - LLC 7 días',
  ...
  private checkScrollDepth(): void {
    ...
    if (scrollPercentage >= 25 && this.scrollDepth < 25) {
      this.facebookPixelService.trackDeepScroll('Landing Presentación 4', 25);
      this.scrollDepth = 25;
    } else if (scrollPercentage >= 50 && this.scrollDepth < 50) {
      this.facebookPixelService.trackDeepScroll('Landing Presentación 4', 50);
      this.scrollDepth = 50;
    } else if (scrollPercentage >= 75 && this.scrollDepth < 75) {
      this.facebookPixelService.trackDeepScroll('Landing Presentación 4', 75);
      this.scrollDepth = 75;
    }
  }
  ...
  onCalendlyClick(): void {
    this.facebookPixelService.trackLead(
      'Calendly CTA - Landing Presentación 4',
      'LLC Presentation Services',
      0.0
    );
  }
